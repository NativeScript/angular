import { Tree, addProjectConfiguration, readProjectConfiguration, updateProjectConfiguration, writeJson } from '@nx/devkit';
...
describe('component Generator', () => {
  it('should create component files correctly', async () => {
    ...
    // ASSERT
    expect(tree.read('libs/lib1/src/lib/example/example.component.ts', 'utf-8')).toMatchSnapshot('component');
    expect(tree.read('libs/lib1/src/lib/example/example.component.html', 'utf-8')).toMatchSnapshot('template');
    expect(tree.read('libs/lib1/src/lib/example/example.component.css', 'utf-8')).toMatchSnapshot('stylesheet');
    expect(tree.read('libs/lib1/src/lib/example/example.component.spec.ts', 'utf-8')).toMatchSnapshot('component test file');
    expect(tree.read('libs/lib1/src/index.ts', 'utf-8')).toMatchSnapshot('entry point file');
  });
  ...
  it('should not generate test file when --skip-tests=true', async () => {
    ...
    // ASSERT
    expect(tree.exists('libs/lib1/src/lib/example/example.component.spec.ts')).toBe(false);
  });
  ...
  it('should inline template when --inline-template=true', async () => {
    ...
    // ASSERT
    expect(tree.read('libs/lib1/src/lib/example/example.component.ts', 'utf-8')).toMatchSnapshot();
    expect(tree.exists('libs/lib1/src/lib/example/example.component.html')).toBe(false);
  });
  ...
  it('should inline styles when --inline-style=true', async () => {
    ...
    // ASSERT
    expect(tree.read('libs/lib1/src/lib/example/example.component.ts', 'utf-8')).toMatchSnapshot();
    expect(tree.exists('libs/lib1/src/lib/example/example.component.css')).toBe(false);
  });
  ...
  it('should not create a style file when --style=none', async () => {
    ...
    // ASSERT
    expect(tree.exists('libs/lib1/src/lib/example/example.component.none')).toBeFalsy();
    expect(tree.read('libs/lib1/src/lib/example/example.component.ts', 'utf-8')).toMatchInlineSnapshot(`
  ...
  it('should create the component correctly and export it in the entry point when "export=true"', async () => {
    ...
    // ASSERT
    const componentSource = tree.read('libs/lib1/src/lib/example/example.component.ts', 'utf-8');
  ...
  it('should create the component correctly and export it in the entry point when is standalone and "export=true"', async () => {
    ...
    const indexSource = tree.read('libs/lib1/src/index.ts', 'utf-8');
    expect(indexSource).toMatchInlineSnapshot(`"export * from './lib/example/example.component';"`);
  });
  ...
  it('should create the component correctly and not export it in the entry point when "export=false"', async () => {
    ...
    const indexSource = tree.read('libs/lib1/src/index.ts', 'utf-8');
    expect(indexSource).not.toContain(`export * from "./lib/example/example.component";`);
  });
  ...
  describe('--module', () => {
    it.each(['./lib.module.ts', 'lib.module.ts', './lib.module', 'lib.module', './lib', 'lib'])('should export it in the entry point when "--module" is set to "%s"', async (module) => {
      // ARRANGE
      const tree = createTreeWithEmptyWorkspace({ layout: 'apps-libs' });
      addProjectConfiguration(tree, 'lib1', {
        projectType: 'library',
    ...
    export class LibModule {}`,
      ...
      // ASSERT
      const indexSource = tree.read('libs/lib1/src/index.ts', 'utf-8');
      expect(indexSource).toContain(`export * from './lib/example/example.component';`);
    });
...
`,
      ...
      tree.write('libs/shared/ui/src/index.ts', `export * from './lib/lib.module';`);
      ...
      // ASSERT
      const moduleSource = tree.read('libs/shared/ui/src/lib/lib.module.ts', 'utf-8');
    ...
    export class NotExportedModule {}`,
      ...
      // ASSERT
      const indexSource = tree.read('libs/lib1/src/index.ts', 'utf-8');
      expect(indexSource).toMatchInlineSnapshot(`"export * from './lib/lib.module';"`);
    });
  ...
  describe('prefix & selector', () => {
    ...
    it('should use the prefix', async () => {
      ...
      const content = tree.read('lib1/src/lib/example/example.component.ts', 'utf-8');
    ...
    it('should allow dash in selector before a number', async () => {
      ...
      const content = tree.read('lib1/src/lib/one-1/one-1.component.ts', 'utf-8');
  ...
  describe('secondary entry points', () => {
    it('should create the component correctly and export it in the entry point', async () => {
      ...
      tree.write('libs/lib1/secondary/src/index.ts', `export * from './lib/secondary.module';`);
      tree.write(
      ...
      // ASSERT
      const componentSource = tree.read('libs/lib1/secondary/src/lib/example/example.component.ts', 'utf-8');
      expect(componentSource).toMatchSnapshot();

      const secondaryIndexSource = tree.read('libs/lib1/secondary/src/index.ts', 'utf-8');
    ...
    it('should not export the component in the entry point when the module it belongs to is not exported', async () => {
      ...
      // ASSERT
      const indexSource = tree.read('libs/lib1/secondary/src/index.ts', 'utf-8');
      expect(indexSource).toBe('');
    });
  });
