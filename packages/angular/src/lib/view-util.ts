...
export class ViewUtil {
	...
	constructor(private namespaceFilters?: NamespaceFilter[]) {
	}
	/**
	...
	private insertChild(parent: View, child: View, previous?: NgView, next?: NgView) {
		...
		} else if (previous) { // if there's a previous, next is the nextSibling of it
			next = previous.nextSibling;
		} else { // no previous or next, append to the parent
